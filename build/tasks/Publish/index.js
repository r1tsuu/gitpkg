...
class PublishTask extends _Task.default {
  async run({
    ...
    const gitpkgRegistryURL = await (0, _getRegistryUrl.default)(registry, this.pkg, pkgPath, this.config); // await uploadPackage(this.config, this.pkg, gitpkgRegistryURL);
